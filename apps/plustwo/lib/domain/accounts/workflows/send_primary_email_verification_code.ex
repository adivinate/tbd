defmodule Plustwo.Domain.Accounts.Workflows.SendPrimaryEmailVerificationCode do
  ...
  use Commanded.Event.Handler, name: "Accounts.Workflows.SendEmailVerificationCode"
  ...
  def handle(%AccountRegistered{uuid: uuid, email: email, is_org: false}, _metadata) do
    verification_code = UUID.uuid4(:hex)

    {:ok, _email_verification_code} =
      set_account_email_verification_code(%{
        account_uuid: uuid,
